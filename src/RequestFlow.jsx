...
import { requestFlow as data } from './request-flow-data';
...
export default function RequestFlow() {
  ...
  return <section className="request-flow" id="request-flow" ref={root} aria-labelledby="request-heading">
    <div className="request-inner">
      <h2 id="request-heading">A request <em>travels</em>.</h2>
      <p className="request-intro">{data.description}</p>
      <div className="request-panel">
        <div className="request-diagram-scroll" tabIndex={0} role="region" aria-label="请求流转图，小屏可左右滑动">
        ...
        <div className="request-log" role="region" aria-label="请求演示日志" tabIndex={0}>
